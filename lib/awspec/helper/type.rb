module Awspec
  module Helper
    module Type
      ...
      TYPES = %w(
        alb ami autoscaling_group cloudformation_stack cloudtrail cloudwatch_alarm cloudwatch_event
        directconnect_virtual_interface ebs ec2 ecr_repository ecs_cluster ecs_container_instance
        ecs_service ecs_task_definition efs elasticache elasticache_cache_parameter_group elasticsearch elb iam_group
